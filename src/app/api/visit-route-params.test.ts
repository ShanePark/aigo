...
describe("visit API route params", () => {
  it.each([
    ...
    ["PATCH place memo", () => patchPlaceMemo(request("PATCH"), context("memoId", "not-a-uuid")), "memoId"],
    ["DELETE place memo", () => deletePlaceMemo(request("DELETE"), context("memoId", "not-a-uuid")), "memoId"],
