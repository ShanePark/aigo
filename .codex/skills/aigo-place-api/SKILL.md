...
4. Research with source notes.
   ...
   - Choose the primary image deliberately. It should show the actual family-use value of the place at card size, not only the building exterior, brand logo, or a generic wide shot. Use `isPrimary: true` only for that representative image, then keep the rest ordered by parent usefulness.
